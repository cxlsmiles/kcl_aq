...
\includegraphics[scale=0.105]{figures/graphical.png}
...
\begin{itemize}
  \item suppinfo.pdf: contains 1) the radial density distributions of the core excited states of the bare ions; 2) partial cross sections  and charge transfer time extracted from the experimental 2D map near the Cl 1s edge.
\end{itemize}
